FILE_JAR=target/Uas_AryaSeptiawan-1.0-SNAPSHOT.jar
HADOOP_USERNAME=hadoopuser
IP_NAMENODE=192.168.1.17
HOME_DIR=/home/hadoopuser/
NAMA_JAR_TUJUAN=Uas_AryaSeptiawan-1.0-SNAPSHOT.jar
PACKAGE_ID=org.example.App
INPUT_FOLDER=/user/hadoopuser/arya/input
OUTPUT_FOLDER=/user/hadoopuser/arya/output
